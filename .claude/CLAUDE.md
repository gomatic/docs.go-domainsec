# `docs.go-domainsec` — public documentation repository

This is the **public** documentation site for [`gomatic/go-domainsec`](https://github.com/gomatic/go-domainsec), created from [`nicerobot/template.repo-docs`](https://github.com/nicerobot/template.repo-docs). It is published to GitHub Pages.
...
- **Keep docs in sync with the source.** When [`gomatic/go-domainsec`](https://github.com/gomatic/go-domainsec)'s API changes, update [`content/`](../content/) to match.
